...
select extensions.ok(
  array(
    ...
    select signature from (values
      ...
      ('read_website_interview_stream(uuid,text,uuid)'),
...
select extensions.ok(
  array(
    ...
    select signature from (values
      ...
      ('authorize_website_interview_stream(uuid,uuid,uuid,text,uuid)'),
      ...
      ('resume_website_interview_stream(uuid,uuid,uuid,text,text)'),
      ...
      ('record_website_interview_stream_response(uuid,uuid,uuid,text,uuid,text,text,text,text)'),
      ('record_website_interview_stream_playout(uuid,uuid,uuid,text,uuid,text,text,text,jsonb)'),
