...
export function mapWebsiteSetupStatus(value) {
  ...
  if(status.voice_protocol_version !== undefined && ![2,3,4,5,6].includes(status.voice_protocol_version))
  ...
  if(amendment && (![3,4,5,6].includes(status.voice_protocol_version) || status.amendment_pending!==true ||
